...
public class DynamicBeat extends JFrame {
	...
	public DynamicBeat() {
		...
		trackList.add(new Track("SwimmingTitleImage.png","StarmanGameImage.jpg","StarmanStartImage.jpg","Starman.mp3","Starman.mp3","Starman"));
		...
		trackList.add(new Track("BonusTitleImage.png","DarkGameImage.jpg","DarkStartImage.jpg","Underworld.mp3","Underworld.mp3","Under World"));
